...
# NOUVELLE MISE À JOUR : Locator pour le titre de la page de liste des produits
PRODUCTS_LIST_PAGE_TITLE = "//android.view.View[@content-desc=\"Liste des produits\"]"

# Locator pour le produit "John Hardy Bracelet" (inchangé)
EXISTING_PRODUCT_VISIBLE = "//android.widget.ImageView[contains(@content-desc, \"Fjallraven\")]"
